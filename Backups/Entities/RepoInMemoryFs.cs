...
public class RepoInMemoryFs : IRepository, IDisposable
{
    private IFileSystem _fileSystem;
    [JsonProperty("path")]
    private string _path;
    public RepoInMemoryFs(string path)
    {
    ...
    {
        var fs = OpenFile((Path / namesOfBackupObj).ToString());
